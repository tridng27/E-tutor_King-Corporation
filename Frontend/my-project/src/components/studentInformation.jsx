  ...
  return (
    <div className="fixed inset-0 flex justify-center items-center bg-black bg-opacity-50">
      <div className="bg-white p-11 rounded-2xl shadow-lg w-[500px] h-[500px] relative">
        <h2 className="text-xl font-semibold text-center mb-4">STUDENT INFORMATION</h2>
        <button 
        ...
        <form>
          ...
          <div className="mb-3">
            ...
            <input type="text" value="Nguyen Van A" className="w-full p-2 border rounded-md bg-gray-100" readOnly />
          </div>

          <div className="mb-3">
            <label className="block text-sm font-medium">Birth Date</label>
            <input type="text" value="27/06/2003" className="w-full p-2 border rounded-md bg-gray-100" readOnly />
          </div>
